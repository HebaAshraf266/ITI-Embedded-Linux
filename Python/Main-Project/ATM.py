...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        password_label = tk.Label(self,text='Enter your password',font=('orbitron',13),bg='RosyBrown4',fg='white')
        ...
        incorrect_password_label = tk.Label(self,text='',font=('orbitron',13),fg='white',bg='RosyBrown4',anchor='n')
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        main_menu_label = tk.Label(self,text='Main Menu',font=('orbitron',13),fg='white',bg='RosyBrown4')
        main_menu_label.pack()

        selection_label = tk.Label(self,text='Please make a selection',font=('orbitron',13),fg='white',bg='RosyBrown4',anchor='w')
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        choose_amount_label = tk.Label(self,text='Choose the amount you want to withdraw',font=('orbitron',13),fg='white',bg='RosyBrown4')
        ...
        twenty_button = tk.Button(button_frame,text='50',command=lambda:withdraw(50),relief='raised',borderwidth=3,width=50,height=5)
        twenty_button.grid(row=0,column=0,pady=5)

        forty_button = tk.Button(button_frame,text='100',command=lambda:withdraw(100), relief='raised',borderwidth=3,width=50,height=5)
        forty_button.grid(row=1,column=0,pady=5)

        sixty_button = tk.Button(button_frame,text='200',command=lambda:withdraw(200),relief='raised',borderwidth=3,width=50,height=5)
        sixty_button.grid(row=2,column=0,pady=5)

        eighty_button = tk.Button(button_frame,text='300',command=lambda:withdraw(300),relief='raised',
                                                       borderwidth=3,
                                                       width=50,
                                                       height=5)
		...
		height=5)
        Another_Choice_Label.grid(row=2,column=1,pady=5)
...
class BalancePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        exit_button = tk.Button(button_frame,text='Exit',command=exit,relief='raised',borderwidth=3,
                                                 width=50,
                                                 height=5)
        ...
        time_label = tk.Label(bottom_frame,font=('orbitron',12,'bold'))
        time_label.pack(side='right')
